    ...
    <form action="MobileCategory.jsp">
      ...
      <button type="submit"><i class="fa fa-search"></i></button>
        ...
        <table align="center" class="paddingBetweenCols">
              <p style="text-align: center"></p>
        <% 
          String uri="jdbc:postgresql://localhost:5432/souqdb";
          try {
                  Connection con=DriverManager.getConnection(uri,"postgres","postgres");
                  Statement st = con.createStatement(
                  ResultSet.TYPE_SCROLL_INSENSITIVE,
                 ResultSet.CONCUR_READ_ONLY
                   );
...
>>>>>>> ac85b7aba0db89ee2a9aa99a57e9e4c4ebe7bc4e
